...
const Developer = ({ animationName = 'idle', ...props }) => {
  ...
  const { scene } = useGLTF('/models/esteban1.glb')
  ...
  const animations = React.useMemo(() => {
    ...
    if (idleAnimation?.animations) {
      ...
      anims.push(idleAnimation.animations[0])
    }
    if (saluteAnimation?.animations) {
      saluteAnimation.animations[0].name = 'salute'
      anims.push(saluteAnimation.animations[0])
    }
    if (clappingAnimation?.animations) {
      clappingAnimation.animations[0].name = 'clapping'
      anims.push(clappingAnimation.animations[0])
    }
    if (victoryAnimation?.animations) {
      victoryAnimation.animations[0].name = 'victory'
      anims.push(victoryAnimation.animations[0])
    }
    return anims
...
useGLTF.preload('/models/esteban1.glb')
